...
<head>
    ...
    <title><?php echo e(__('error.offline_title')); ?></title>
    <style>
        :root {
...
<body>
    <div class="container">
        <header class="header">
            ...
            <h1><?php echo e(__('error.offline_title')); ?></h1>
            <p class="subtitle">
                <?php echo e(__('error.offline_description')); ?>
        ...
        <main class="card">
            <ul class="offline-list">
                <li><?php echo e(__('error.offline_reason_1')); ?></li>
                <li><?php echo e(__('error.offline_reason_2')); ?></li>
                <li><?php echo e(__('error.offline_reason_3')); ?></li>
                <li><?php echo e(__('error.offline_reason_4')); ?></li>
            </ul>
            ...
            <button onclick="window.location.reload()" class="btn">
                ...
                <?php echo e(__('error.offline_button')); ?>
...
</html><?php /**PATH /home/compvge/public_html/bootstrap/../app/Themes/standard/views/pages/offline.blade.php ENDPATH**/ ?>