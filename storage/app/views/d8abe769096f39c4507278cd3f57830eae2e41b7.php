<button 
    class="scrollup" 
    data-tooltip="<?php echo e(__('admin.scroll_to_top')); ?>"
    data-tooltip-position="left"
    aria-label="<?php echo e(__('admin.scroll_to_top')); ?>"
>
    <?php if (isset($component)) { $__componentOriginal15b69f80cf0e25ca0fac925c6f6e481777724d4f = $component; } ?>
<?php $component = Flute\Core\Modules\Icons\Components\IconComponent::resolve(['path' => 'ph.bold.arrow-up-bold','class' => 'scrollup__icon'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php /**PATH /home/compvge/public_html/bootstrap/../app/Core/Modules/Admin/Resources/views/partials/scrollup.blade.php ENDPATH**/ ?>