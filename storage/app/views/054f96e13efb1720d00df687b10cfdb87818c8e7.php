...
<div class="stickers-sidebar__main" data-remove-handler>
    <header class="right_sidebar__header">
        <h5 class="right_sidebar__title">
            <?php echo e(__('skinchanger.stickers.title')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'Themes.standard.views.components.fields.input','data' => ['type' => 'text','name' => 'sticker_search','placeholder' => ''.e(__('skinchanger.stickers.search')).'','value' => ''.e($search).'','dataHandler' => 'sticker-search','dataWeaponIndex' => ''.e($weaponIndex).'','dataSkinId' => ''.e($skinId).'','dataSlotIndex' => ''.e($slotIndex).'','dataServerId' => ''.e($serverId).'','dataTeam' => ''.e($team).'','autocomplete' => 'off']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['type' => 'text','name' => 'sticker_search','placeholder' => ''.e(__('skinchanger.stickers.search')).'','value' => ''.e($search).'','data-handler' => 'sticker-search','data-weapon-index' => ''.e($weaponIndex).'','data-skin-id' => ''.e($skinId).'','data-slot-index' => ''.e($slotIndex).'','data-server-id' => ''.e($serverId).'','data-team' => ''.e($team).'','autocomplete' => 'off']); ?>
...
<?php endif; ?>
            ...
            <div class="stickers-sidebar__count">
                <?php echo e(__('skinchanger.stickers.found', ['count' => $total])); ?>
        ...
        <div class="stickers-sidebar__grid" id="stickers-grid">
            <?php if(count($stickers) > 0): ?>
                <div class="sticker-item sticker-item--remove" data-handler="remove-sticker-selection"
                    ...
                    data-slot-index="<?php echo e($slotIndex); ?>" data-server-id="<?php echo e($serverId); ?>"
                    data-team="<?php echo e($team); ?>">
...
<?php endif; ?>
                    ...
                    <div class="sticker-item__info">
                        <div class="sticker-item__name">
                            <?php echo e(__('skinchanger.buttons.remove_sticker', 'Remove Sticker')); ?>
                ...
                <?php $__currentLoopData = $stickers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sticker): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="sticker-item" data-handler="select-sticker"
                        data-sticker-id="<?php echo e(str_replace('sticker-', '', $sticker['id'] ?? '')); ?>"
                        data-sticker-name="<?php echo e($sticker['name'] ?? ''); ?>"
                        data-sticker-image="<?php echo e($sticker['image'] ?? ''); ?>" data-weapon-index="<?php echo e($weaponIndex); ?>"
                        data-skin-id="<?php echo e($skinId); ?>" data-slot-index="<?php echo e($slotIndex); ?>"
                        data-server-id="<?php echo e($serverId); ?>" data-team="<?php echo e($team); ?>"
                        <?php if(isset($sticker['rarity']['color'])): ?> style="--rarity-color: <?php echo e($sticker['rarity']['color']); ?>" <?php endif; ?>>

                        <div class="sticker-item__image">
                            <?php if(!empty($sticker['image'])): ?>
                                <img src="<?php echo e($sticker['image']); ?>" alt="<?php echo e($sticker['name'] ?? ''); ?>" loading="lazy">
                            <?php else: ?>
...
<?php endif; ?>
                        ...
                        <div class="sticker-item__info">
                            <div class="sticker-item__name">
                                <?php echo e($sticker['name'] ?? 'Unknown Sticker'); ?>
...
<?php endif; ?>
                    ...
                    <div class="stickers-sidebar__empty-text">
                        <?php if(!empty($search)): ?>
                            <?php echo e(__('skinchanger.stickers.no_results')); ?>

                        <?php else: ?>
                            <?php echo e(__('skinchanger.stickers.no_stickers')); ?>
        ...
        <?php if($hasMore && $page < $pages): ?>
            <div class="sidebar-load-more" style="display: none;">
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'Themes.standard.views.components.button','data' => ['type' => 'outline-primary','dataHandler' => 'load-more-stickers','dataPage' => ''.e($page + 1).'','dataWeaponIndex' => ''.e($weaponIndex).'','dataSkinId' => ''.e($skinId).'','dataSlotIndex' => ''.e($slotIndex).'','dataServerId' => ''.e($serverId).'','dataTeam' => ''.e($team).'','dataSearch' => ''.e($search).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'outline-primary','data-handler' => 'load-more-stickers','data-page' => ''.e($page + 1).'','data-weapon-index' => ''.e($weaponIndex).'','data-skin-id' => ''.e($skinId).'','data-slot-index' => ''.e($slotIndex).'','data-server-id' => ''.e($serverId).'','data-team' => ''.e($team).'','data-search' => ''.e($search).'']); ?>
...
<?php /**PATH /home/compvge/public_html/bootstrap/../app/Modules/Skinchanger/Resources/views/sidebar/stickers.blade.php ENDPATH**/ ?>