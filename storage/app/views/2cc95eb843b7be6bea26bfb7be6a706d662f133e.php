...
<?php endif; ?>
    ...
    <div class="d-flex flex-column">
        <?php echo e($social->key); ?>

        <small class="text-muted">#<?php echo e($social->id); ?></small>
    </div>
</div><?php /**PATH /home/compvge/public_html/app/Core/Modules/Admin/Packages/Social/Resources/views/cells/main.blade.php ENDPATH**/ ?>