<header class="admin-header">
    <div class="navbar">
        <div class="navbar__container">
            <button class="sidebar__toggle" <?php if(cookie()->get('admin-sidebar-collapsed', 'false') !== 'true'): ?> style="display: none" <?php endif; ?>>
...
<?php endif; ?>
            ...
            <div class="navbar__content <?php if(cookie()->get('container-width', 'normal') === 'wide'): ?> container-wide <?php endif; ?> container">
                <div class="row">
                    <div class="col-md-12">
...
<?php endif; ?>
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <button class="navbar__customization" id="customization-trigger" aria-label="Customize"
                                    data-tooltip="<?php echo e(__('admin.customization')); ?>">
                                    <?php if (isset($component)) { $__componentOriginal15b69f80cf0e25ca0fac925c6f6e481777724d4f = $component; } ?>
...
<?php endif; ?>
                                ...
                                <button class="navbar__search" id="search-trigger">
                                    <?php if (isset($component)) { $__componentOriginal15b69f80cf0e25ca0fac925c6f6e481777724d4f = $component; } ?>
<?php $component = Flute\Core\Modules\Icons\Components\IconComponent::resolve(['path' => 'ph.bold.magnifying-glass-bold'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Flute\Core\Modules\Icons\Components\IconComponent::class))->getConstructor()): ?>
...
<?php unset($__componentOriginal15b69f80cf0e25ca0fac925c6f6e481777724d4f); ?>
<?php endif; ?>
                                    <span><?php echo e(__('def.lets_search')); ?></span>
...
<?php /**PATH /home/compvge/public_html/bootstrap/../app/Core/Modules/Admin/Resources/views/layouts/header.blade.php ENDPATH**/ ?>