<?php if(!empty(footer()->socials()->all())): ?>
    <div class="footer__socials" itemscope itemtype="https://schema.org/Organization">
        <h6 class="footer__socials-title"><?php echo __('def.socials'); ?></h6>
        ...
        <div class="footer__socials-container">
            <?php $__currentLoopData = footer()->socials()->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $social): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e($social->url); ?>" data-tooltip="<?php echo __($social->name); ?>" aria-label="<?php echo __($social->name); ?>" 
...
<?php endif; ?>
<?php /**PATH /home/compvge/public_html/app/Themes/standard/views/components/footer/socials.blade.php ENDPATH**/ ?>