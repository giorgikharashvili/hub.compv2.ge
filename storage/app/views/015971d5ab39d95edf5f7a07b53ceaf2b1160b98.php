...
<?php endif; ?>
    ...
    <h3 class="status-title">❤️ <?php echo e(__('admin-update.all_updated')); ?></h3>
    <p class="status-description"><?php echo e(__('admin-update.no_updates')); ?></p>
</div> <?php /**PATH /home/compvge/public_html/app/Core/Modules/Admin/Packages/Update/Resources/views/components/no-updates.blade.php ENDPATH**/ ?>