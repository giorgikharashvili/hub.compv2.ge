...
<head>
    <meta charset="UTF-8">
    <title>@t('auth.confirmation.subject')</title>
</head>
                ...
                <table width="700" cellpadding="0" cellspacing="0" border="0"
                    ...
                    <tr>
                        <td style="padding:20px; text-align:center;">
                            <h1 style="color:#9667FD; margin:10px; line-height:1;">@t('auth.confirmation.subject')</h1>
                        </td>
                    </tr>
                    <tr>
                        <td style="background-color:#1A1A1A; border-radius:10px; padding:40px; color:#ffffffb2;">
                            ...
                            <p style="margin-bottom:20px;">@t('auth.confirmation.thanks_for_register')</p>
                            <table align="center" cellpadding="0" cellspacing="0" border="0"
                                style="margin:30px auto;">
                                <tr>
                                    <td style="background-color:#9667FD; border-radius:5px; text-align:center;">
                                        <a href="{{ $url }}"
                                            style="display:block; padding:12px 24px; color:#ffffff; text-decoration:none; font-weight:500; font-size:14px;">@t('auth.confirmation.verify_account')</a>
                                    </td>
                                </tr>
                            </table>
                            <p style="margin-bottom:20px;text-align:center; ">@t('auth.confirmation.ignore')</p>
                            <small
